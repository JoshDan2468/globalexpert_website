...
const researchDevelopmentService = {
  ...
  summary:
    "CONSTRUCTION Construction activities are driven by Client’s demands and process includes;",
  intro:
    "Construction activities are driven by Client’s demands and process includes: Costs estimation, Time schedule, Resources Quality, Communication Risk, Construction planning, Field procurement, Equipment installation, Commissioning, Start-up support, Training.",
  image: heroImage,
    ...
    <main className='overflow-x-hidden bg-white'>
      ...
      <section className='relative isolate overflow-hidden bg-[#012402] px-4 pb-14 pt-24 sm:px-6 sm:pb-18 sm:pt-28 lg:px-8 lg:pb-20 lg:pt-32'>
        <div className='absolute inset-0'>
          <img
            src={researchDevelopmentService.image}
            alt=''
            aria-hidden='true'
        ...
        <div className='relative z-10 container mx-auto grid items-center gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:gap-10'>
          ...
          >
            <img
              src={researchDevelopmentService.image}
              alt={researchDevelopmentService.imageAlt}
      ...
      <section className='bg-[linear-gradient(180deg,#ffffff_0%,#f7fbf7_100%)] px-4 py-14 sm:px-6 sm:py-18 lg:px-8 lg:py-20'>
        <div className='container mx-auto grid gap-8 lg:grid-cols-[1.05fr_0.95fr]'>
          ...
          >
            ...
            <h2 className='mt-4 text-2xl font-bold text-[#132015] sm:text-3xl'>
              Construction-focused engineering research and development support
            </h2>
            <p className='mt-5 text-sm leading-7 text-[#5a6b5d] sm:text-[0.98rem] sm:leading-8'>
              {researchDevelopmentService.intro}
            </p>
            <div className='mt-8 grid gap-4 sm:grid-cols-3'>
              <div className='rounded-[1.2rem] bg-[#eef6ef] p-4 sm:rounded-[1.4rem] sm:p-5'>
                ...
                <p className='mt-2 text-sm leading-6 text-[#49604d]'>
                  Covers cost, schedule, resources, quality, communication, and
                  risk planning.
                </p>
              </div>
              <div className='rounded-[1.2rem] bg-[#eef6ef] p-4 sm:rounded-[1.4rem] sm:p-5'>
                ...
                <p className='mt-2 text-sm leading-6 text-[#49604d]'>
                  Supports procurement, construction, installation,
              ...
              <div className='rounded-[1.2rem] bg-[#eef6ef] p-4 sm:rounded-[1.4rem] sm:p-5'>
                ...
                <p className='mt-2 text-sm leading-6 text-[#49604d]'>
                  Includes environmental, workplace safety, health, and fire
          ...
          >
            ...
            <div className='mt-6 space-y-4'>
              {researchDevelopmentService.capabilities.map((item) => (
                <div
                  key={item}
        ...
        <div className='container mx-auto mt-8 grid gap-8 lg:grid-cols-2'>
          ...
          >
            ...
            <div className='mt-6 space-y-4'>
              {researchDevelopmentService.outcomes.map((item) => (
          ...
          >
            ...
            <div className='mt-6 space-y-5'>
              {researchDevelopmentService.process.map((step, index) => (
