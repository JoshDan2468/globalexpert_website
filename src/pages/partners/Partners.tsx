...
const partners: Partner[] = Object.entries(partnerLogoModules)
...
const Partners = () => {
  ...
  return (
    <main className='overflow-x-hidden bg-[#f7f7f3]'>
      ...
      <section className='relative isolate overflow-hidden px-4 pb-14 pt-28 sm:px-6 sm:pb-16 sm:pt-32 lg:px-8 lg:pb-20'>
        ...
        <div className='relative z-10 container mx-auto max-w-6xl'>
          ...
          >
            ...
            <p className='mt-4 max-w-2xl text-sm leading-7 text-white/78 sm:text-base'>
              We collaborate with trusted organizations across sectors,
              delivery models, and strategic initiatives. Explore the network
              below, search by name, and reach out if you would like to work
              with us.
            </p>
      ...
      <section
        id='partner-grid'
        className='px-4 pb-14 pt-10 sm:px-6 sm:pb-16 sm:pt-12 lg:px-8 lg:pb-20'
      >
        <div className='container mx-auto max-w-6xl'>
          ...
          >
            <div className='text-center'>
              ...
              <h2 className='mt-4 text-xl font-semibold text-[#1a241d] sm:text-2xl'>
                Organizations We Work With
              </h2>
            </div>

            <div className='mt-8 flex flex-col gap-4 rounded-[1.5rem] bg-white p-4 shadow-[0_16px_36px_rgba(15,23,42,0.05)] ring-1 ring-[#0c4010]/6 sm:p-5'>
              <div className='flex flex-col gap-4 md:flex-row md:items-center md:justify-between'>
                <div>
                  <p className='text-sm font-semibold text-[#152118]'>
                    Browse partner logos
                  </p>
          ...
          {filteredPartners.length > 0 ? (
            <div className='grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6'>
              {filteredPartners.map((partner, index) => (
                ...
                >
                  <Link
                    to={partner.to}
                    className='group flex h-24 items-center justify-center rounded-xl bg-[#efefec] px-3 text-center shadow-[0_10px_24px_rgba(15,23,42,0.04)] transition-all duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-[0_16px_32px_rgba(15,23,42,0.08)] sm:h-28'
                  ...
                  >
                    <div className='flex h-full w-full flex-col items-center justify-center'>
                      <img
                        ...
                        loading='lazy'
                        className='max-h-10 w-auto max-w-[130px] object-contain transition-transform duration-300 group-hover:scale-105 sm:max-h-12 sm:max-w-[140px]'
                      />
                      <span className='mt-2 text-[10px] leading-4 text-[#647266] opacity-0 transition-opacity duration-300 group-hover:opacity-100'>
                        {partner.name}
                      </span>
                    </div>
                  </Link>
            ...
            <div className='rounded-[1.5rem] bg-white px-6 py-12 text-center shadow-[0_16px_36px_rgba(15,23,42,0.05)] ring-1 ring-[#0c4010]/6'>
              <p className='text-lg font-semibold text-[#152118]'>
                No partner matched "{query}"
              </p>
              <p className='mt-2 text-sm text-[#617064]'>
                Try a shorter keyword or clear the search to view the full partner list.
              </p>
              <button
                type='button'
                onClick={() => setQuery("")}
                className='mt-5 inline-flex rounded-full bg-[#012402] px-5 py-3 text-[11px] font-semibold uppercase tracking-[0.12em] text-white transition-transform duration-300 hover:-translate-y-0.5'
              >
                Reset Search
              </button>
            </div>
