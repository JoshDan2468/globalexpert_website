...
const insights = [
  {
    ...
    excerpt:
      "How digital twin technology is revolutionizing predictive maintenance and operational efficiency.",
  },
  {
    tag: "Sustainability",
    title: "Decarbonization Strategies for Industrial Operations",
    excerpt:
      "Practical approaches to reducing carbon footprint while maintaining operational performance.",
  },
  {
    tag: "Project Delivery",
    title: "Agile Project Management in Capital-Intensive Industries",
    excerpt:
      "Adapting agile methodologies for large-scale engineering projects and complex stakeholder environments.",
  },
];
